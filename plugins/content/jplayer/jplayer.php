...
class plgContentJplayer extends JPlugin
{
	...
	function onContentPrepare($context, &$article, &$params)
	{
		...
		/* Video */
		$videofolder		= $this->params->get('videofolder','media/video');
		$videowidth		= $this->params->get('videowidth',400);
		$videoheight		= $this->params->get('videoheight',300);
		/* Audio */
		$audiofolder		= $this->params->get('audiofolder','media/audio');
		$audiowidth		= $this->params->get('audiowidth',300);
		$audioheight		= $this->params->get('audioheight',20);
		/* Youtube */
		$youtuberelated	= ($this->params->get('youtuberelated',1)) ? true : false;
		$youtubeborder	  	= ($this->params->get('youtubeborder',0)) ? true : false;
		$youtubecolors	  	= $this->params->get('youtubecolors',0);
		$youtuberesolution	= $this->params->get('youtuberesolution',2);
		$youtubewidth		= $this->params->get('youtubewidth',480);
		$youtubeheight	  	= $this->params->get('youtubeheight',385);
		/* Playlist */
		$playlistfolder	= $this->params->get('playlistfolder','media/playlist');
		$playlistsize		= $this->params->get('playlistsize',350);
		$playlistposition  	= $this->params->get('playlistposition','bottom');
		$shuffle			= ($this->params->get('shuffle',0)) ? true : false;
		/* Player */
		$playerversion	  	= $this->params->get('playerversion','4-7-811');
		$controlbar		= $this->params->get('controlbar','bottom');
		...
		$frontcolor		= $this->params->get('frontcolor','');
		$lightcolor		= $this->params->get('lightcolor','');
		$screencolor		= $this->params->get('screencolor','');
		/* General */
		$fullscreen		= ($this->params->get('fullscreen',0)) ? 'true' : 'false';
		$autoplay			= ($this->params->get('autoplay',0)) ? 'true' : 'false';
		$repeat			= $this->params->get('repeat','none');
		$downloadLink		= $this->params->get('downloadLink',1);
		$skin			= $this->params->get('skin','');
		$logo			= $this->params->get('logo','');
		$jplayerLink		= $this->params->get('jplayerLink',0);
		$registeredonly	= $this->params->get('registeredonly',0);
		$registeredonlymsg	= $this->params->get('registeredonlymsg',0);
		/* Advanced */
		$debugMode		= ($this->params->get('debugMode',0)) ? true : false;
